...
/**
 * mod_self - Q9 opcode that performs the modulus expression on the stack
...
/**
 * pucha_self - Q11 opcode that prints the char at the top of the stack,
...
/**
 * pstring_self - Q12 opcode that prints the string starting at the
 * top of the stack
 * followed by a new
 * @list_head: head of linked list stack
 * @lineNumber: track of the current position of input being read
...
/**
 * rotl_self- Q13 opcode that rotates the stack to the top
 * @list_head: head of linked list stack
 * @lineNumber: track of the current position of input being read
 *
 * Return: nil
 */
void rotl_self(stack_t **list_head,
...
/**
 * rotr_self - Q14 opcode that rotates the stack to the bottom
 * @list_head: head of linked list stack
 * @lineNumber: track of the current position of input being read
 *
 * Return: nil
